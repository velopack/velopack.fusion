...
public partial class MainWindow : Window
{
    ...
    public MainWindow()
    {
        ...
        _um.SetUrlOrPath(Program.UpdateUrl);
    ...
    private void UpdateStatus()
    {
        ...
        //sb.AppendLine($"This app version: {(_um.IsInstalled ? _um.GetCurrentVersion() : "(n/a - not installed)")}");
        sb.AppendLine($"This app version: {_um.GetCurrentVersion()}");
